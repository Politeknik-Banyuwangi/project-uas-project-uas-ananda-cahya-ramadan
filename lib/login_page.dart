        ...
        body: Container(
          ...
          decoration: const BoxDecoration(
              gradient: LinearGradient(
                  ...
                  colors: [
                Color.fromARGB(255, 61, 51, 130),
                Color.fromARGB(255, 118, 44, 141)
              ])),
          child: Column(
                                  ...
                                  child: MaterialButton(
                                    ...
                                    child: const Text("Login",
                                        style: TextStyle(
                                            ...
                                            fontSize: 16)),
                                    color: Color.fromARGB(255, 90, 22, 124),
                                  ...
                                  child: MaterialButton(
                                    ...
                                    child: const Text("Reset Password",
                                        style: TextStyle(
                                            ...
                                            fontSize: 16)),
                                    color:
                                        const Color.fromARGB(255, 90, 22, 124),
                                    shape: const RoundedRectangleBorder(
                                        borderRadius: BorderRadius.all(
                                            Radius.circular(50))),
                                    padding: const EdgeInsets.all(16),
  ...
  fetchLogin(BuildContext context, String email, String password) async {
    ...
    try {
      ...
      response = await dio.post(
        'https://testing-flutter-saya.herokuapp.com/api/auth/login',
        data: {
          'email': email,
          'password': password,
        },
